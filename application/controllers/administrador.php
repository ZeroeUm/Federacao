...
class administrador extends CI_Controller
{
    ...
    function getHistorico($federado)
    {
        ...
        if(!empty($historico))
        {
            ...
            echo ("Não foi encontrado nenhum registro do federado escolhido.<br/>Verifique se o federado já realizou alguma gradua��o na federação Paulista de Artes Marciais Interestilos.");
