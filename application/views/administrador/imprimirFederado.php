...
function imprimirInformacao(div)
{
    ...
    var html = "<html><head>"+
               ...
               conteudo.innerHTML+
               "</body></html>";
    var janelaImprimir = window.open("", "Tela de impress�o", 'width=750,height=650,top=50,left=50,toolbars=no,scroolbar=yes,status=no,resizable=yes');
...
<?php
    ...
    echo form_fieldset("Impress�o de dados do federado");
    echo form_open('', $attr);
    echo img($imagem);
?>
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
            ...
            echo form_input('fMaterna',(($fed['fMaterna'] == "")?"N�o fornecido":$fed['fMaterna']),$inFMaterna);
        ?>
    </div>
</div>
<div class="control-group">
    ...
    <div class="controls">
        <?php
            ...
            echo form_input('fPaterna',(($fed['fPaterna'] == "")?"N�o fornecido":$fed['fPaterna']),$inFPaterna)
        ?>
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    <?php
        echo form_label("Gradua��o atual","graduacao",$label);
    ?>
    <div class="controls">
        <?php
...
<div class="control-group">
    <?php
        echo form_label("Endere�o Residencial","endereco",$label);
    ?>
    <div class="controls">
        <?php
...
<?php
echo form_button('btnImprimir','Imprimir Informa��es','id="btnImprimir" onClick="imprimirInformacao(\'conteiner\')" class="btn btn-primary"');
echo form_close();
