...
<?php } ?>
<div class="row-fluid">
    <a class="btn btn-primary pull-right" href="/coordenador/criarEvento" style="margin-left: 10px;">Criar Novo evento</a>
<a class="btn btn-inverse pull-right" href="/coordenador/listaEventos">Lista de participantes</a>
</div>
...
<div class="span2">Total de Filiais: <span class="label label-warning"><?php echo $numeros['filiais']['0']['total'];?></span></div>
</div>