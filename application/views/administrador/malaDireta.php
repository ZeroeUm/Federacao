...
<div id="row-fluid">
    ...
    if (!empty($mensagem)):
        ...
        echo form_submit('btnAlterarar', 'Alterar Mensagem', 'id="btnAlterar" class="btn btn-success"');
        echo form_close();
        ...
        echo form_submit('btnIncluir', 'Incluir nova mensagem', 'id="btnIncluir" class="btn btn-success"');
        echo form_close();
        echo form_fieldset_close();
    endif;
    ?>
