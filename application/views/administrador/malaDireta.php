...
<div id="row-fluid">
    ...
    if (!empty($mensagem)):
        ...
        echo form_textarea('mensagem', html_entity_decode(nl2br($mensagem[0]['mensagem']), ENT_QUOTES, "UTF-8"), "rows='30' id='mensagem' style='width:100%'");
        echo form_submit('btnAlterarar', 'Alterar Mensagem', 'id="btnAlterar" class="btn btn-primary"');
        echo form_close();
        ...
        echo form_submit('btnIncluir', 'Incluir nova mensagem', 'id="btnIncluir" class="btn btn-primary"');
        echo form_close();
        echo form_fieldset_close();
    endif;
    ?>
