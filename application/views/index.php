...
<html lang="en">
    ...
    <body>
        ...
        <aside id="sidebar" class="column">
            <img src="#" alt="imagem usu�rio" title="imagem usuario" width="150" height="200" style="padding:5px 20px" />
            <h3>Alunos</h3>
            <ul class="toggle">
                <li class="icn_profile"><a href="#">Hist�rico pessoal de notas</a></li>
                <li class="icn_folder"><a href="#">Cronograma de eventos da Federação</a></li>
                <li class="icn_view_users"><a href="#">Hist�rico de atividades</a></li>
                <li class="icn_folder"><a href="#">Curr�culo da modalidade</a></li>
            </ul>

            <h3>Instrutores</h3>
            <ul class="toggle">
                <li class="icn_edit_article"><a href="#">Manuten��o de dados de alunos</a></li>
                ...
                <li class="icn_categories"><a href="#">Manute��o de participantes em Graduação de Faixa</a></li>
            </ul>
            
            <h3>Coordenadores</h3>
            <ul class="toggle">
                <li class="icn_new_article"><a href="#">Verificar professores da modalidade</a></li>
                <li class="icn_categories"><a href="#">Manuten��o de dados de filiais</a></li>
                <li class="icn_new_article"><a href="#">Emitir certificados</a></li>
                <li class="icn_folder"><a href="#">Enviar pedido de compra de faixa</a></li>
                <li class="icn_new_article"><a href="#">Emitir prontu�rio de notas para pr�-avalia��o</a></li>
                <li class="icn_categories"><a href="#">Manuten��o do curr�culo da modalidade</a></li>
                <li class="icn_edit_article"><a href="#">Verificar rela��o de participantes em Graduação</a></li>
            </ul>
            <h3>Administrador</h3>
            <ul class="toggle">
                <li class="icn_folder"><a href="#">Enviar notificações via e-mail</a></li>
                <li class="icn_categories"><a href="#">Manuten��o de dados de Federados</a></li>
                <li class="icn_money"><a href="#">Manuten��o de pedidos de compra de faixa</a></li>
                <li class="icn_tags"><a href="#">Verificar hist�rico de atividades de Federado</a></li>
                <li class="icn_categories"><a href="#">Manuten��o de dados de Filiais</a></li>
                <li class="icn_edit_article"><a href="#">Manunten��o de mala-direta � aniversariantes</a></li>
            </ul>
        ...
        <section id="main" class="column">
            ...
            <h4 class="alert_info">Bem vindo ao Dworker administra��o MMN.</h4>
            ...
            <article class="module width_3_quarter">
                <header><h3 class="tabs_involved">Alcance seu Sucesso</h3>
                    <ul class="tabs">
                        <li><a href="#tab1">Indica��es Recebidas</a></li>
                        ...
                        <table class="tablesorter" cellspacing="0"> 
                            ...
                            <tbody> 
                                <tr> 
                                    ...
                                    <td><input type="image" src="<?php echo base_url() . 'assets/images/icn_edit.png'?>" title="Edit"><input type="image" src="<?php echo base_url() . 'assets/images/icn_trash.png'?>" title="Trash"></td> 
                                </tr> 
                                <tr> 
                                    <td><input type="checkbox"></td> 
                                    <td>Lorem Ipsum Dolor Sit Amet</td> 
                    ...
                    <div id="tab2" class="tab_content">
                        <table class="tablesorter" cellspacing="0"> 
                            ...
                            <tbody> 
                                ...
                                <tr> 
                                    <td><input type="checkbox"></td> 
                                    <td>Como alcan�ar o sucesso de forma eficaz</td> 
            ...
            <article class="module width_quarter">
                ...
                <div class="message_list">
                    <div class="module_content">
                        <div class="message"><p>Reconhecimento de lideran�a 2012.</p>
                            <p><strong>balsamo Perfumes</strong></p></div>
                        <div class="message"><p>Aniversario de 5 anos da empresa Bult Comesmeticos.</p>
                            <p><strong>John Doe</strong></p></div>
                        <div class="message"><p>Conhe�a mais sobre MMN no Brasil.</p>
                            <p><strong>Carlos Godoy</strong></p></div>
                        <div class="message"><p>Reuni�o Anual de vendedores MMN.</p>
