            ...
            <ul style="display: block; ">
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li class="icn_categories"><a href="<?php echo site_url('coordenador/index'); ?>">Manutençao de dados de filiais</a></li>
                        ...
                        <li class="icn_new_article"><a href="<?php echo site_url('coordenador/index'); ?>">Emitir prontuário de notas para pró-avaliação</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li class="icn_edit_article"><a href="<?php echo site_url('administrador/maladireta'); ?>">Manutenção de mala-direta dos aniversariantes</a></li>
