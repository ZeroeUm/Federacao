        ...
        <div id="sidebar">
            ...
            <ul style="display: block; ">
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li class="icn_new_article"><a href="<?php echo site_url('coordenador/index'); ?>">Verificar professores da modalidade</a></li>
                        ...
                        <li class="icn_new_article"><a href="<?php echo site_url('coordenador/index'); ?>">Emitir prontuário de notas para pré-avalia��o</a></li>
