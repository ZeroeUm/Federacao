...
<div class="span9">
    <form action="/coordenador/criarEvento" method="post">
    
     <label>Data do evento</label> 
    <input type="text" name="data[evento_graduacao][data_evento]" class="input-block-level" id="datepicker" placeholder="Data do Evento">
    
    
    <label>Numero do evento</label> 
    <input type="text" name="data[evento_graduacao][numero_evento]" class="input-block-level" placeholder="Numero do evento">
