...
INSERT INTO `estados` (`id_estados`, `sigla`, `nome`, `capital`) VALUES
(1, 'SP', 'São Paulo', 'São Paulo'),
(4, 'RJ', 'Rio de Janeiro', 'Rio de Janeiro'),
(5, 'MG', 'Minas Gerais', 'Belo Horizonte'),
(6, 'PR', 'Paraná', 'Curitiba'),
(7, 'RS', 'Rio Grande do Sul', 'Porto Alegre'),
(8, 'SC', 'Santa Catarina', 'Florianópolis'),
(9, 'ES', 'Espírito Santo', 'Vitória'),
(10, 'BA', 'Bahia', 'Salvador'),
(11, 'SE', 'Sergipe', 'Aracaju'),
(12, 'AL', 'Alagoas', 'Maceió'),
(13, 'PE', 'Pernambuco', 'Recife'),
(14, 'PB', 'Paraíba', 'João Pessoa'),
(15, 'RN', 'Rio Grande do Norte', 'Natal'),
(16, 'CE', 'Ceará', 'Fortaleza'),
(17, 'PI', 'Piauí', 'Teresina'),
(18, 'MA', 'Maranhão', 'São Luís'),
(19, 'PA', 'Pará', 'Belém'),
(20, 'AP', 'Amapá', 'Macapá'),
(21, 'AM', 'Amazonas', 'Manaus'),
(22, 'TO', 'Tocantins', 'Palmas'),
(23, 'RR', 'Roraima', 'Boa Vista'),
(24, 'RO', 'Rondônia', 'Porto Velho'),
(25, 'AC', 'Acre', 'Rio Branco'),
(26, 'MT', 'Mato Grosso', 'Cuiabá'),
(27, 'MS', 'Mato Grosso do Sul', 'Campo Grande'),
(28, 'GO', 'Goiás', 'Goiânia'),
(29, 'DF', 'Distrito Federal', 'Brasília');
...
(1, 'FEPAMI', '000.000.000/0000-00', '(11)1111-1111', '(22)2222-2222', 'contato@dworker.com.br', 'Federação', 1, 1, 1),
(2, 'Academia Galax', '111.111.111/1111-11', '(22)2222-2222', '(22)2222-2222', 'academia@dworker.com.br', 'Obi Wan Kinobi', 1, 3, 106),
(3, 'Academia da Luz', '222.222.222/2222-22', '(11)1111-1111', NULL, 'contato@dworker.com.br', 'João', 1, 4, 111);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aqui contem a lista de todos os que são instrutores dentro d' AUTO_INCREMENT=5 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aqui nessa tabela fica a lista com todos os instrutores de a' AUTO_INCREMENT=4 ;
