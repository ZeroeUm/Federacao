...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`federacao` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
...
CREATE TABLE `endereco` (
  ...
  `logradouro` VARCHAR(80) COLLATE utf8_general_ci NOT NULL,
  `numero` INT(5) NOT NULL,
  `complemento` VARCHAR(20) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `escolaridade` (
  ...
  `descricao` VARCHAR(40) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `estados` (
  ...
  `sigla` VARCHAR(2) COLLATE utf8_general_ci DEFAULT NULL,
  `nome` VARCHAR(30) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `evento_graduacao` (
  ...
  `descricao` LONGTEXT COLLATE utf8_general_ci,
...
CREATE TABLE `federado` (
  ...
  `filiacao_materna` VARCHAR(60) COLLATE utf8_general_ci DEFAULT NULL,
  `filiacao_paterna` VARCHAR(60) COLLATE utf8_general_ci DEFAULT NULL,
  `sexo` VARCHAR(1) COLLATE utf8_general_ci NOT NULL COMMENT 'M/F',
  `data_nasc` DATE NOT NULL,
  `rg` VARCHAR(12) COLLATE utf8_general_ci NOT NULL,
  `telefone` VARCHAR(13) COLLATE utf8_general_ci NOT NULL,
  `celular` VARCHAR(14) COLLATE utf8_general_ci DEFAULT NULL,
  `email` VARCHAR(50) COLLATE utf8_general_ci NOT NULL,
  `caminho_imagem` VARCHAR(50) COLLATE utf8_general_ci NOT NULL DEFAULT 'sem foto',
...
CREATE TABLE `filial` (
  ...
  `nome` VARCHAR(60) COLLATE utf8_general_ci NOT NULL,
  `cnpj` VARCHAR(19) COLLATE utf8_general_ci NOT NULL,
  `telefone` VARCHAR(13) COLLATE utf8_general_ci DEFAULT NULL,
  `fax` VARCHAR(13) COLLATE utf8_general_ci DEFAULT NULL,
  `email` VARCHAR(50) COLLATE utf8_general_ci NOT NULL,
  `representante` VARCHAR(60) COLLATE utf8_general_ci DEFAULT NULL,
  `id_modalidade` INT(2) NOT NULL,
...
CREATE TABLE `fornecedor` (
  ...
  `nome` VARCHAR(40) COLLATE utf8_general_ci NOT NULL,
  `telefone` VARCHAR(13) COLLATE utf8_general_ci NOT NULL,
  `email` VARCHAR(50) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `graduacao` (
  `id_modalidade` INT(2) NOT NULL,
  `grau` VARCHAR(7) COLLATE utf8_general_ci NOT NULL,
  `ordem` INT(2) NOT NULL,
  `faixa` VARCHAR(30) COLLATE utf8_general_ci NOT NULL,
  `curriculo` BLOB,
...
CREATE TABLE `itens_pedido` (
  ...
  `tamanho` VARCHAR(2) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `mala-direta` (
  ...
  `mensagem` MEDIUMTEXT COLLATE utf8_general_ci NOT NULL COMMENT 'campo para armazenar a mensagem de mala-direta aos aniversariantes',
  PRIMARY KEY (`id`)
...
INSERT  INTO `matricula`(`id_federado`,`id_modalidade`,`id_filial`,`data_matricula`,`matricula_filial`) VALUES (1,1,8,'2000-01-10','2000-01-10'),(2,1,2,'2000-03-20','2006-12-01'),(6,1,1,'2000-09-12','2000-09-12'),(7,3,1,'2011-11-11','2013-03-23'),(8,1,3,'2012-09-11','2012-09-11'),(9,1,2,'2008-08-08','2008-08-08'),(10,1,1,'2010-10-10','2013-03-06'),(11,1,1,'2010-12-01','2010-12-01'),(12,1,6,'2010-09-21','2010-09-21'),(13,1,8,'2011-08-22','2011-08-22'),(20,1,6,'2013-03-06','2013-03-06');
...
CREATE TABLE `modalidade` (
  ...
  `nome` VARCHAR(15) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `nacionalidade` (
  `id` INT(2) NOT NULL AUTO_INCREMENT,
  `nacionalidade` VARCHAR(30) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `prontuario` (
  `id_federado` INT(11) NOT NULL,
  `id_evento` INT(8) NOT NULL,
  `arquivo` VARCHAR(100) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `status_pedido` (
  `id` INT(1) NOT NULL AUTO_INCREMENT,
  `descricao` VARCHAR(20) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=INNODB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `tipo_federado` (
  `id` INT(1) NOT NULL AUTO_INCREMENT,
  `tipo` VARCHAR(15) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=INNODB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
