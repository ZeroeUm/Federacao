...
--
-- Servidor: localhost
-- Tempo de Geração: 28/01/2013 às 10:07:24
...
CREATE TABLE IF NOT EXISTS `federado` (
  ...
  `id_tipo_federado` int(11) DEFAULT NULL,
  ...
  KEY `fk_federado_5` (`id_tipo_federado`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `federado` (`id_federado`, `nome`, `data_nasc`, `rg`, `telefone`, `celular`, `email`, `id_escolaridade`, `id_status_federado`, `id_endereco`, `id_nacionalidade`, `id_tipo_federado`) VALUES
(1, 'Coordenador de Taekwondo', '0000-00-00', '12.345.678-9', '(11) 3456-789', '(11) 98765-432', 'taekwondo@tkd.com', 6, 1, 1, 11, 2),
(2, 'Felipe de Oliveira', '1985-10-01', '22.222.222-7', '(11) 3333-333', '', 'felipe@chipsetdesenvolvimento.com', 6, 1, 1, 11, 2);
...
INSERT INTO `filial` (`id_filial`, `nome`, `cnpj`, `telefone`, `email`, `id_modalidade`, `id_instrutor`, `id_endereco`) VALUES
(6, 'Felipe de Oliveira da Silva', '', '1168020408', 'felipe@chipsetdesenvolvimento.com', 1, 1, NULL),
(7, 'Felipe de Oliveira da Silva', '', '1168020408', 'felipe@chipsetdesenvolvimento.com', 2, 1, NULL),
(8, 'Felipe de Oliveira da Silva', '', '1168020408', 'felipe@chipsetdesenvolvimento.com', 1, 1, NULL),
(9, 'Felipe de Oliveira da Silva', '', '1168020408', 'felipe@chipsetdesenvolvimento.com', 1, 1, NULL),
(10, 'Felipe de Oliveira da Silva', '', '1168020408', 'felipe@chipsetdesenvolvimento.com', 1, 1, NULL);
...
ALTER TABLE `federado`
  ...
  ADD CONSTRAINT `fk_federado_5` FOREIGN KEY (`id_tipo_federado`) REFERENCES `tipo_federado` (`id_tipo_federado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `instrutor`
  ADD CONSTRAINT `fk_instrutor_1` FOREIGN KEY (`id_federado`) REFERENCES `federado` (`id_federado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
